...
# Install Go
RUN apt-get update && curl -L https://go.dev/dl/go1.22.0.linux-amd64.tar.gz --output /root/go1.22.0.linux-amd64.tar.gz && tar xvf /root/go/go1.22.0.linux-amd64.tar.gz
