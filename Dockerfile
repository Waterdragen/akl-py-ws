...
# Install Go
RUN apt-get update && curl --help && curl -O https://go.dev/dl/go1.21.7.linux-amd64.tar.gz && file go1.21.7.linux-amd64.tar.gz && tar -C /root -xf go1.21.7.linux-amd64.tar.gz
